    ...
    <div className="h-full flex">
      <div className="flex flex-[3] h-full items-center justify-center">
        <form className="flex flex-col gap-5">
          ...
          <input className="p-5 border border-gray-600 rounded" name="username" type="text" placeholder="Username" />
          ...
          <button className="p-5 rounded bg-teal-700 text-white font-bold cursor-pointer disabled:bg-[#bed9d8] disabled:cursor-not-allowed">Register</button>
          <Link className="text-blue-500 hover:text-blue-700" to="/login">Do you have an account?</Link>
        </form>
      </div>
